...
const Navbar = () => {
    const {activeMenu, setActiveMenu,isClicked,screeSize, setScreeSize, setIsClicked,handleClick} = useStateContent()
    useEffect(()=>{
            ...
            <div className={"flex"}>
                ...
                >
                    <div className={"flex  items-center gap-2 cursor-pointer p-1 hover:bg-light-gray rounded-lg"} onClick={()=>handleClick('userProfile')}>
                        ...
                        <p>
                            <span className={"text-gray-400 text-14"}>Hi </span>{' '}<span className={"text-gray-400 font-bold ml-1 text-14"}> Sotiris</span>
                        </p>
